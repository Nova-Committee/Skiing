...
import committee.nova.mods.skiing.core.registry.SkiingTab;
...
public class LanguageGenerator extends LanguageProvider {
    ...
    public LanguageGenerator(PackOutput packOutput, String modid) {
    ...
    protected void addTranslations() {
        ...
        add(SkiingTab.SKIING_TAB.get().getDisplayName().getString(), "Skiing");
    }
}
